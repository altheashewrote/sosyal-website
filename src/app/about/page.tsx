            ...
            <section className="relative flex flex-col w-screen h-1500 bg-slic3r-black px-20 gap-10">
                ...
                <div className="relative flex flex-row justify-between gap-10">
                    <div className="flex flex-col items-start gap-10">
                        ...
                        image="/images/events/boba_bass_01.jpg"
                        />
                        <div className="font-helvetica max-h-140 text-ara-white text-right flex flex-col gap-6 pl-30 py-30 opacity-0">
                            <div>
                        ...
                        image="/images/events/studios_dh_01.jpg"
                        />
                        <div className="font-helvetica max-h-140 text-ara-white text-right flex flex-col gap-6 pl-54 py-70">
                            <div>
                        ...
                        image="/images/events/three_founders_01.jpg"
                        />
                        <div className="font-helvetica max-h-140 text-ara-white text-right flex flex-col gap-6 pl-30 py-60">
                            <div>
                                <h3 className="font-bold uppercase">22 November 2025</h3>
                                <p className="font-medium uppercase tracking-wide">Operation Knockout: Unofficial Knock2 Afters</p>
                            </div>
                        ...
                        image="/images/events/chrispinoy_iku_2.jpg"
                        />
                        <div className="font-helvetica max-h-140 text-ara-white text-right flex flex-col gap-6 pl-30 py-50 opacity-0">
                            <div>
                                <h3 className="font-bold uppercase">22 November 2025</h3>
                                <p className="font-medium uppercase tracking-wide">Operation Knockout: Unofficial Knock2 Afters</p>
                            </div>
                    ...
                    <div className="w-0.5 h-1500 bg-chromeangels-grey"></div>
                    <div className="flex flex-col gap-10">
                        <div className="font-helvetica max-h-140 text-ara-white flex flex-col gap-6 py-30">
                            <div>
                        ...
                        image="/images/events/labubass_01.jpg"
                        />
                        <div className="font-helvetica max-h-140 text-ara-white flex flex-col gap-6 py-30">
                            <div>
                        ...
                        image="/images/events/studios_hz_04.jpg"
                        />
                        <div className="font-helvetica max-h-140 text-ara-white flex flex-col gap-6 py-50">
                            <div>
                        ...
                        image="/images/events/ara_sfc.jpg"
                        />
                        <div className="font-helvetica max-h-140 text-ara-white flex flex-col gap-6 py-40">
                            <div>
