...
export default function Footer() {
    return (
        <div className="relative bg-rave-black bottom-0 left-0 w-full px-20 py-15 pb-25 flex flex-row justify-between">
            ...
            <div className="flex flex-col items-start">
                <ul className="font-helvetica text-xs text-right tracking-wider font-semibold leading-8 text-ara-white">
                    ...
                    <li><p className="text-chromeangels-grey font-light">© 2026 SOSYAL STAGES LLC</p></li>
                </ul>
            </div>
        </div>
    )
